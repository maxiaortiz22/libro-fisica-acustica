...
de unidades y el análisis dimensional introducidos en el
capítulo~\ref{chap:unidad-1}. Del capítulo~\ref{chap:unidad-2} se retomarán la
...
\begin{figure}[htbp]
    \centering
    \input{figures/tikz/unidad-3/oscilacion-propagacion.tex}
...
\begin{figure}[htbp]
    \centering
    \input{figures/tikz/unidad-3/longitudinal-transversal.tex}
...
En el modelo masa--resorte del capítulo~\ref{chap:unidad-2}, una fuerza
...
\begin{figure}[htbp]
    \centering
    \input{figures/tikz/unidad-3/mas-cinematica.tex}
...
o \emph{pitch}. \verify{Para tonos simples y bajo condiciones comparables, la
frecuencia suele relacionarse con la altura tonal percibida, pero esta última
depende de la señal, del oyente y del contexto.} La sonoridad, el
...
\verify{Un tono físico real tiene un inicio y un final; la conexión y la
desconexión pueden introducir transitorios y hacen que la señal no sea una
sinusoide ilimitada.} Por esta razón conviene distinguir el modelo ideal de la
...
estudiará en el capítulo~\ref{chap:unidad-4}.
...
\begin{figure}[htbp]
    \centering
    \input{figures/tikz/unidad-3/parlante-medio.tex}
...
\begin{figure}[htbp]
    \centering
    \input{figures/tikz/unidad-3/onda-tiempo-espacio.tex}
...
introdujo en el capítulo~\ref{chap:unidad-2}; aquí interesa su relación
...
\begin{figure}[htbp]
    \centering
    \input{figures/tikz/unidad-3/superposicion-desfase.tex}
...
\verify{La cancelación activa de ruido utiliza medición, procesamiento y una
...
receptor.} Este ejemplo permite aplicar la superposición, pero no demuestra
...
\begin{description}
    ...
    \verify{la audiometría liminar utiliza estímulos y niveles calibrados,
    ...
    sola que existe o no una pérdida auditiva.}
...
impedancia se desarrollarán en el capítulo~\ref{chap:unidad-4}. La
...
distinciones preparan el estudio de las magnitudes acústicas del
capítulo~\ref{chap:unidad-4}.
...
velocidad de propagación ni atributos perceptuales. El
capítulo~\ref{chap:unidad-4} utilizará esta base para definir las magnitudes
