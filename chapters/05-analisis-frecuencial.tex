...
\begin{enumerate}
    \item \textbf{Espectro de una vocal /a/.} Grabada en Audacity, muestra $f_0 = 120$ Hz (pitch), $F_1 = 730$ Hz, $F_2 = 1090$ Hz, $F_3 = 2440$ Hz, $F_4 = 3400$ Hz (formantes que dan el timbre).
