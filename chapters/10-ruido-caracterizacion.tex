...
\begin{quote}
    \textbf{Ejemplo clínico.}\\
    Para un paciente con tinnitus a 6 kHz, un audífono con NBN centrado en 6 kHz (ancho $\approx$1/3 octava) puede aliviar la molestia.
\end{quote}
...
\begin{itemize}
    ...
    \item \textbf{Control:}\\
    Mitigación en fuente, trayecto y receptor; normativas OMS/OSHA.
\end{itemize}
